...
const CHANGELOG: Release[] = [
  {
    ...
    changes: [
      ...
      'LinkedIn message import: contact matching now also recognizes German umlauts spelled out as ASCII (ä/ö/ü/ß written as ae/oe/ue/ss), e.g. "Grünwald" now matches a LinkedIn export spelling the same person "Gruenwald". Also fixes this for the existing mail-sync name+company fallback match, which shares the same matching code.',
    ],
  },
  {
    version: '4.6.1',
